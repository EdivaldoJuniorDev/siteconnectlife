      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
            <path
              d="M9.5 3C7 3 5 5 5 7.5C5 9.5 6 11 7.5 12L9.5 20.5C10 23 11 26 12.5 26C13 26 13.5 25 14 23L14.5 23C15 25 15.5 26 16 26C17.5 26 18.5 23 19 20.5L21 12C22.5 11 23.5 9.5 23.5 7.5C23.5 5 21.5 3 19 3C17.5 3 16.5 4 14 4C11.5 4 10.5 3 9.5 3Z"
              fill="#1A4731"
            />
            <path
              d="M10.5 6.5C11.5 6.5 12 7 13 7C14 7 14.5 6.5 15.5 6.5"
              stroke="white"
              strokeWidth="1.2"
              strokeLinecap="round"
              opacity="0.4"
